...
public type PostCrmV3ObjectsTicketsBatchRead_readQueries record {
...
public type PatchCrmV3ObjectsTicketsTicketid_updateQueries record {
...
public type GetCrmV3ObjectsTickets_getpageQueries record {
...
public type GetCrmV3ObjectsTicketsTicketid_getbyidQueries record {
    # A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
    string[] associations?;
    # Whether to return only results that have been archived.
    boolean archived = false;
